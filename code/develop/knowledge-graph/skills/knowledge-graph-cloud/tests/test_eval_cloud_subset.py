...
class CloudSubsetEvaluatorTests(unittest.TestCase):
    ...
    def run_cli(arguments):
        actions = EVAL._current_cloud80_action_closure()
        with mock.patch.object(
            EVAL,
            "_require_formal_cloud80_bootstrap_context",
            return_value=actions,
        ):
            return EVAL.main(arguments)
